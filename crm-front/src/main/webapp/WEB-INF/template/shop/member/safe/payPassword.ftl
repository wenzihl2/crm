...
<body class="login" mycenter="member_safe">
	...
	<div id="content">
		...
		<div class="right">
			<div class="mydd">
				<div class="mydd_m">支付密码修改</div>
				<div class="mydd_c">
					<form id="inputForm" class="validate" action="updatePayPassword" method="post">
						...
						<table width="99%" border="0" align="center" cellpadding="0" cellspacing="0" class="liuyan">
							<tbody>
								<tr>
									<td width="28%" align="right">新支付密码：</td>
									<td align="left">
								...
								<tr>
									<td width="28%" align="right">确认支付密码：</td>
									<td align="left">
