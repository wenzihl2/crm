    ...
    $(function() {
    	$("#navtab2").ligerTab({
    		onBeforeSelectTabItem:function(tabid){
    			if(tabid == "view") {
    				location.href = "${base}/admin/sso/dept/${id}.jhtml?BackURL=[@BackURL/]"
    			} else if(tabid == "modify") {
    				location.href = "${base}/admin/sso/dept/${id}/editForm.jhtml?BackURL=[@BackURL/]";
    			} else if(tabid == "delete") {
    				location.href = "${base}/admin/sso/dept/${id}/delete.jhtml?BackURL=[@BackURL/]";
    			} else if(tabid == "appendChild") {
    				location.href = "${base}/admin/sso/dept/${id}/appendChildForm.jhtml?BackURL=[@BackURL/]";
    			} else if(tabid == "move") {
    				location.href = "${base}/admin/sso/dept/${id}/move.jhtml?BackURL=${base}/admin/sso/dept/${id}/move.jhtml";
    			}
            }
    	});
    });
