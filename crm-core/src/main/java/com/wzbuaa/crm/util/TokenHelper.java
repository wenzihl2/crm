...
public class TokenHelper {
     ...
     * 保存token值的默认命名空间
     */
    public static final String TOKEN_NAMESPACE = "crm_wzbuzz_tokens";
    
    /**
     * 持有token名称的字段名
     */
    public static final String TOKEN_NAME_FIELD = "crm_wzbuzz_token_name";
    private static final Logger LOG = LoggerFactory.getLogger(TokenHelper.class);
    private static final Random RANDOM = new Random();
    private static RedisCache redisCache;
    
    public static void setRedisCacheClient(RedisCache redisCache) {  
        TokenHelper.redisCache = redisCache;  
    }
    ...
    private static void setCacheToken(HttpServletRequest request, String tokenName, String token) {
        try {
            ...
            redisCache.cache(tokenName0, token);
    ...
    public static String buildTokenCacheAttributeName(String tokenName) {
        return TOKEN_NAMESPACE + "_" + tokenName;
    }
    ...
    public static boolean validToken(HttpServletRequest request) {
        ...
        String cacheToken = redisCache.get(tokenCacheName);
