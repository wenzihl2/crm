...
public class UserLogUtils {
    ...
    private static final Logger SYS_USER_LOGGER = LoggerFactory.getLogger("drp-sys-user");
    ...
    public static Object getIp() {
        ...
        if (requestAttributes != null && requestAttributes instanceof ServletRequestAttributes) {
            return RequestUtils.getIpAddr(((ServletRequestAttributes) requestAttributes).getRequest());
        }
