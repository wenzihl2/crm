 ...
 * @since 0.1
 */
public class UsernamePasswordCompanyToken implements HostAuthenticationToken, RememberMeAuthenticationToken {
     ...
     */
    public UsernamePasswordCompanyToken(final String username, final char[] password, final Long companyId) {
        this(username, password, companyId, false, null);
    }
     ...
     */
    public UsernamePasswordCompanyToken(final String username, final String password, final Long companyId) {
        this(username, password != null ? password.toCharArray() : null, companyId, false, null);
    }
     ...
     * @since 0.2
     */
    public UsernamePasswordCompanyToken(final String username, final char[] password, final Long companyId, final String host) {
        this(username, password, companyId, false, host);
    }
     ...
     * @since 1.0
     */
    public UsernamePasswordCompanyToken(final String username, final String password, final Long companyId, final String host) {
        this(username, password != null ? password.toCharArray() : null, companyId, false, host);
    }
     ...
     * @since 0.9
     */
    public UsernamePasswordCompanyToken(final String username, final Long companyId, final char[] password, final boolean rememberMe) {
        this(username, password, companyId, rememberMe, null);
    }
     ...
     * @since 0.9
     */
    public UsernamePasswordCompanyToken(final String username, final String password, final Long companyId, final boolean rememberMe) {
        this(username, password != null ? password.toCharArray() : null, companyId, rememberMe, null);
    }
    ...
    public UsernamePasswordCompanyToken(final String username, final String password, final Long companyId,
                                 final boolean rememberMe, final String host) {
        this(username, password != null ? password.toCharArray() : null, companyId, rememberMe, host);
    }
