...
public class UserCacheAspect extends BaseCacheAspect {
     ...
     * 匹配用户Service
     */
    @Pointcut(value = "target(com.wzbuaa.crm.service.sso.S_userService)")
    ...
    public void cacheEvictAdvice(Object arg) {
        ...
        if (arg instanceof S_userDomain) {
            //evict user
            evict((S_userDomain) arg);
        }
    }
    ...
    ////cache 抽象实现
    ////////////////////////////////////////////////////////////////////////////////
    public void put(S_userDomain user) {
        if (user == null) {
            return;
        }
        Long id = user.getId();
    ...
    public void evict(S_userDomain user) {
        if (user == null) {
            return;
        }
        Long id = user.getId();
