...
//            throw new UnauthorizedException(Message.error(errorCode, new String[]{resourcePermission}).toString());
//        }
    }
    ...
    public void assertHasAllPermission(String[] permissions, String errorCode) {
        ...
        if (permissions == null || permissions.length == 0) {
            throw new UnauthorizedException(Message.error(errorCode, new String[]{resourceIdentity + ":" + Arrays.toString(permissions)}).getContent());
        }
